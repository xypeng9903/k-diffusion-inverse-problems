...
do
    ...
    --logdir runs/sample_condition_openai/guidance_II/${DATASET}/inpaint/${COV}/lam_-1 
    ...
    --logdir runs/sample_condition_openai/guidance_II/${DATASET}/gaussian_deblur/${COV}/lam_-1 
    ...
    --logdir runs/sample_condition_openai/guidance_II/${DATASET}/motion_deblur/${COV}/lam_-1 
    ...
    --logdir runs/sample_condition_openai/guidance_II/${DATASET}/super_resolution/${COV}/lam_-1 
done
