...
do
    ...
    --logdir runs/sample_condition/guidance_diffpir/${DATASET}/inpaint/lam_${LAM} \
    --lam ${LAM}
    ...
    --logdir runs/sample_condition/guidance_diffpir/${DATASET}/gaussian_deblur/lam_${LAM} \
    --lam ${LAM}
    ...
    --logdir runs/sample_condition/guidance_diffpir/${DATASET}/motion_deblur/lam_${LAM} \
    --lam ${LAM} 
    ...
    --logdir runs/sample_condition/guidance_diffpir/${DATASET}/super_resolution/lam_${LAM} \
    --lam ${LAM}
done
