...
do
    ...
    do
        ...
        --logdir runs/sample_condition_openai/rebuttal/guidance_II/ode/${DATASET}/gaussian_deblur/${COV}/lam_${LAM} \
        --lam ${LAM} \
        --ode
        ...
        --logdir runs/sample_condition_openai/rebuttal/guidance_II/ode/${DATASET}/motion_deblur/${COV}/lam_${LAM} \
        --lam ${LAM} \
        --ode
        ...
        --logdir runs/sample_condition_openai/rebuttal/guidance_II/ode/${DATASET}/inpaint/${COV}/lam_${LAM} \
        --lam ${LAM} \
        --ode
        ...
        --logdir runs/sample_condition_openai/rebuttal/guidance_II/ode/${DATASET}/super_resolution/${COV}/lam_${LAM} \
        --lam ${LAM} \
        --ode
    done
done